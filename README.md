...
![Entanglement Demo](media/entanglement_demo.gif)
...
![Game Comparison](media/comparison.gif)
...
![Red Popups](media/red_popups.gif)
...
![Strong Popups](media/strong_popups.gif)
...
![Splitting Popups](media/splitting_popups.gif)

### Suffer.

Yes, you can turn everything on at the same time.

![Chaos of Popups](media/chaos_of_popups.gif)

### Challenge Mode

![Challenge Mode](media/challenge.gif)
